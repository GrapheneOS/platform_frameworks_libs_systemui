 ...
 */
package com.android.personalcontext.ace.prototype.weather
    ...
    data class ChipContent(
        ...
        companion object {
            ...
            fun toBundle(bundle: Bundle, contents: List<ChipContent>) {
                ...
                bundle.putSerializable(KEY_START_TIMES, ArrayList(contents.map { it.startTime }))
                bundle.putSerializable(KEY_END_TIMES, ArrayList(contents.map { it.endTime }))
                bundle.putStringArrayList(
                    KEY_EVENT_TITLES,
            ...
            fun fromBundle(bundle: Bundle): List<ChipContent> {
                ...
                val startTimes =
                    bundle.getSerializable(KEY_START_TIMES) as? ArrayList<Instant?>
                        ?: return emptyList()
                val endTimes =
                    bundle.getSerializable(KEY_END_TIMES) as? ArrayList<Instant?>
                        ?: return emptyList()
