...
internal fun CallWidgetContainer(widget: CallVisualizerWidget) {
  ...
  val isDisplayMoreResultsEnabled =
    remember(detailedCards, generalCardsEmails, generalCardsMessages) {
      getIsDisplayingMoreResultsEnabled(detailedCards, generalCardsEmails, generalCardsMessages)
    }
  ...
  Column(
    ...
    if (
      ...
      WidgetShowAllResultsButton(
        widget.ctaDisplayMoreResults.details.title.toString(),
        onClick = {
...
@Composable
private fun WidgetAiDisclaimer(aiDisclaimer: String) {
