 ...
 * @property listUuid The UUID of the list the card belongs to.
 */
...
data class CallVisualizerDetailedCard(
  ...
  val dataSource: RemoteAction? = null,
  val listUuid: String,
  val feedback: CallVisualizerFeedback? = null,
)
...
/** Data class for the feedback in the Call Visualizer Detailed Card. */
data class CallVisualizerFeedback(
  val label: String?,
  val positiveFeedback: DisplayInsight,
  val negativeFeedback: DisplayInsight,
)
