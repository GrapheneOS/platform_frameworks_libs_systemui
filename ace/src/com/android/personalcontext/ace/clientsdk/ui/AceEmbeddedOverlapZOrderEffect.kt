...
import com.android.personalcontext.ace.clientsdk.state.AceEmbeddedOverlapBehavior.SetZOrderBehind.WithFade
 ...
 *
 * If required by [com.android.personalcontext.ace.clientsdk.state.AceEmbeddedOverlapBehavior], this
 * effect is also responsible for fading out the [AceEmbeddedSurfaceView] upon overlap. It does this
 * by drawing a "background" overlay on top of the SurfaceView, which it ensures has a z-order of
