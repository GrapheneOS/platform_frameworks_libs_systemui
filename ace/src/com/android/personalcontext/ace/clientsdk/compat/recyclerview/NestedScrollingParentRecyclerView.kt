 ...
 */
package com.android.personalcontext.ace.clientsdk.compat.recyclerview
...
constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0) :
    ...
    override fun onStartNestedScroll(
        ...
        return when (orientation) {
            LinearLayoutManager.VERTICAL -> axes and ViewCompat.SCROLL_AXIS_VERTICAL != 0
            LinearLayoutManager.HORIZONTAL -> axes and ViewCompat.SCROLL_AXIS_HORIZONTAL != 0
            else -> false
        }
    }
