 ...
 */
package com.android.personalcontext.ace.clientsdk.compat
...
import com.android.personalcontext.ace.clientlib.AceEmbeddedUiSize
import com.android.personalcontext.ace.clientsdk.compat.observable.DistinctObservableDelegates
import com.android.personalcontext.ace.clientsdk.state.AceEmbeddedOverlapBehavior
import com.android.personalcontext.ace.clientsdk.state.AceEmbeddedOverlapBehaviorEnum
...
import com.android.personalcontext.ace.clientsdk.state.AceEmbeddedUiState
import com.android.personalcontext.ace.clientsdk.state.AceEmbeddedUiVisibility
...
import com.android.personalcontext.ace.clientsdk.state.AceEmbeddedUiVisibility.Pending
...
import com.android.personalcontext.ace.clientsdk.state.AceEmbeddedZOrderOverrideValue
import com.android.personalcontext.ace.clientsdk.state.NullableRect
import com.android.personalcontext.ace.prototype.PrototypeInsightUtils.toPrototypeInsight
import com.android.personalcontext.ace.prototype.embeddedscroll.EmbeddedScrollInsight
 ...
 * [AceEmbeddedProvider][com.android.personalcontext.ace.clientlib.AceEmbeddedProvider], fully
 * managing the lifecycle of a ACE embedded session by invoking the appropriate
 * [com.android.personalcontext.ace.clientlib.AceEmbeddedProvider.connect] and
 * [com.android.personalcontext.ace.clientlib.AceEmbeddedSession.update] operations behind the
 * scenes.
 *
 ...
 *   [com.android.personalcontext.ace.clientsdk.compat.recyclerview.NestedScrollingParentRecyclerView].
 *
...
class AceEmbeddedSurfaceViewCompat : FrameLayout, NestedScrollingChild3 {
     ...
     */
    var hiddenContent: View? = null
    /**
     * The child view that's displayed when the ACE embedded session state is
     * [AceEmbeddedUiVisibility.Pending].
     */
    var pendingContent: View? = null
    /**
     * The child view that's displayed when the ACE embedded session state is
     * [AceEmbeddedUiVisibility.Error].
     */
    var errorContent: View? = null
