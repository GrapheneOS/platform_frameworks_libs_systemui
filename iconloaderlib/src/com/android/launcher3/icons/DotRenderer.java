...
public class DotRenderer {
    ...
    private final RadialGradient mShadowShader;
    ...
    public DotRenderer(int iconSizePx) {
        ...
        // The start factor of .3 was picked to closely resemble the shadows generated by using blur
        mShadowShader = new RadialGradient(0, 0, mDrawnRadius,
    ...
    public void draw(Canvas canvas, DrawParams params) {
        ...
        // We draw the dot relative to its center. Use canvas.scale so that the shadow layer
        // is also scaled down appropriately.
        canvas.save();
        canvas.translate(centerX, centerY);
        canvas.scale(params.scale, params.scale);
        mCirclePaint.setShader(mShadowShader);
        canvas.drawCircle(0, 0, mDrawnRadius, mCirclePaint);
